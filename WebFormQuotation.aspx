<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WebFormQuotation.aspx.cs" 
    Inherits="GNEnterprise.WebForm13" EnableEventValidation="false"%>
    ...
    <table class="auto-style41" id="tblItem ">
        <tr>
            <td class="auto-style65">
                <asp:Label ID="lblSaleID" runat="server" Text="Quotation ID"></asp:Label>
                <br />

            </td>
            <td class="auto-style10">                    
                <%--<asp:DropDownList ID="ddlSales" runat="server" AutoPostBack="true">
                </asp:DropDownList>--%>
            </td>
            ...
            <td class="auto-style19">
                <asp:DropDownList ID="ddlPartyName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Dropdown1_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            ...
            <td class="auto-style18">
                <asp:TextBox ID="txtGstNo" runat="server" AutoPostBack="True" placeholder="GST Number" Visible ="false"></asp:TextBox>
            </td>
            <td class="auto-style18">
            ...
            <td class="auto-style18"></td>
            <td class="auto-style18">                
                <asp:Button ID="btnUpdateBill" runat="server" Text="UPDATE BILL" Visible="false"/>
            </td>
            <td class="auto-style18">
    ...
    <table class="auto-style23">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td class="auto-style21" colspan="3" rowspan="3">
                <asp:TextBox ID="txtDescription2" runat="server" Width="510px" placeholder="Note" TextMode="MultiLine" Rows="3" Text="18 % GST Applicable."></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
            <td>&nbsp;</td>
