<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WebFormDeliveryChallan.aspx.cs" Inherits="GNEnterprise.WebForm12" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RadioButtonList ID="rblOptions" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rblOptions_SelectedIndexChanged">
        <asp:ListItem ID="rbSales" Value="Sales" runat="server" AutoPostBack="true" Text="Sales" GroupName="options" />
        <asp:ListItem ID="rbQuotation" Value="Quotation" runat="server" AutoPostBack="true" Text="Quotation" GroupName="options" />
    </asp:RadioButtonList>

    <table class="auto-style41" id="tblItem ">
        <tr>
            <td class="auto-style19">
                <asp:Label ID="lblSaleID" runat="server" Text="ID"></asp:Label>
            </td>
            <td class="auto-style19">
                <%--<asp:DropDownList ID="DropDownListSalesId" runat="server" DataSourceID="SqlDataSource1" DataTextField="saleId" DataValueField="saleId">
                </asp:DropDownList>--%>
                <asp:DropDownList ID="DropDownListSalesId" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListSalesId_SelectedIndexChanged">
                </asp:DropDownList>

                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbGNEnterpriseConStr %>" SelectCommand="SELECT [saleId] FROM [tblSale]"></asp:SqlDataSource>
            </td>
       <%--     <td class="auto-style10">

                <asp:Label ID="lblSaleValue" runat="server" Text="1001"></asp:Label>
                <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return GetSelectedRow(this)"></asp:LinkButton>
            </td>--%>
            ...
            <td class="auto-style18">
                <asp:Label ID="lblRNo" runat="server" Text="R.No.:"></asp:Label>
            </td>
            <td class="auto-style18">
    ...
    <table class="auto-style24" border="1">
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName1" runat="server" Height="20px" Width="177px" ></asp:DropDownList>
            </td>
            <td class="auto-style37">
               <%-- <asp:TextBox ID="txtHSN1" runat="server" Width="177px"  ></asp:TextBox>--%>
                <asp:TextBox ID="txtQuantity1" runat="server" Width="177px" AutoPostBack="True"></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                &nbsp;</td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtUnit1" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName2" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN2" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity2" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit2" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice2" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style39">
                <asp:DropDownList ID="ddlProductName3" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN3" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style39">
                <asp:TextBox ID="txtQuantity3" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit3" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style39">
                <asp:TextBox ID="txtUnitPrice3" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style39">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName4" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN4" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity4" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit4" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice4" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName5" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN5" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity5" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit5" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice5" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName6" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN6" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity6" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit6" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice6" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName7" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN7" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity7" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit7" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice7" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName8" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN8" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity8" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit8" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice8" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName9" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN9" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity9" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit9" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice9" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName10" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN10" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity10" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit10" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice10" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName11" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN11" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity11" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit11" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice11" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style40">
                <asp:DropDownList ID="ddlProductName12" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN12" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style40">
                <asp:TextBox ID="txtQuantity12" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit12" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style40">
                <asp:TextBox ID="txtUnitPrice12" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style40">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName13" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN13" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity13" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit13" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice13" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName14" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN14" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity14" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit14" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice14" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName15" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN15" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity15" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit15" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice15" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName16" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN16" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity16" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit16" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice16" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName17" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN17" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity17" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit17" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice17" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName18" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN18" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity18" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit18" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice18" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName19" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtHSN19" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity19" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit19" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice19" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
        ...
        <tr>
            ...
            <td class="auto-style37">
                <asp:DropDownList ID="ddlProductName20" runat="server" Height="20px" Width="177px"  ></asp:DropDownList>
            </td>
            <%--<td class="auto-style37">
                <asp:TextBox ID="txtHSN20" runat="server" Width="177px"  ></asp:TextBox>
            </td>--%>
            <td class="auto-style37">
                <asp:TextBox ID="txtQuantity20" runat="server" Width="177px"  ></asp:TextBox>
            </td>
             <td class="auto-style37">
                <asp:TextBox ID="txtUnit20" runat="server" Width="177px"  ></asp:TextBox>
            </td>
           <%-- <td class="auto-style37">
                <asp:TextBox ID="txtUnitPrice20" runat="server" Width="177px"  ></asp:TextBox>
            </td>
            <td class="auto-style37">
    ...
    <%--<asp:GridView ID="gvSales" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid"
        BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" AutoGenerateColumns="False"
        ShowFooter="True" HorizontalAlign="Center" DataSourceID="XmlDataItem" OnSelectedIndexChanged="gvSales_SelectedIndexChanged">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Product Name" SortExpression="ProductName">
                ...
                <ItemTemplate>
                    <asp:DropDownList ID="ddlProduct" runat="server" DataSourceID="SqlDataProduct" DataTextField="productName" DataValueField="productId"
                        OnClientClick="return GetSelectedRow(this)">
                    </asp:DropDownList>
                    <%--<asp:DropDownList ID="ddlProduct" runat="server" OnSelectedIndexChanged="ddlProduct" AutoPostBack="false">
                    </asp:DropDownList>
            ...
            <asp:TemplateField HeaderText="Quantity" SortExpression="Quantity" ItemStyle-CssClass="quantityTxtCell">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Unit Price" SortExpression="UnitPrice">
                ...
                <ItemTemplate>
                    <asp:TextBox ID="txtUnitPrice" runat="server" Text='<%# Bind("Quantity") %>'></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField Header  SortExpression="Total">
                <EditItemTemplate>
    ...
    <%--<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999"
        BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="tempSalesItemId"
        DataSourceID="SqlDataTemp" ForeColor="Black" HorizontalAlign="Center" ShowFooter="True">
        <Columns>
            ...
            <asp:TemplateField HeaderText="ProductName" SortExpression="tempSalesItemProductName">
                <EditItemTemplate>
                    <asp:DropDownList ID="ddlProductNameEdit" runat="server" DataSourceID="SqlDataProduct" DataTextField="productName" DataValueField="productId">
                    </asp:DropDownList>
                    <asp:SqlDataSource runat="server" ID="SqlDataProduct" ConnectionString='<%$ ConnectionStrings:dbGNEnterpriseConStr %>'
                        SelectCommand="SELECT * FROM [tblProduct]"></asp:SqlDataSource>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:DropDownList ID="ddlProductName" runat="server" DataSourceID="SqlDataProduct" DataTextField="productName" DataValueField="productId">
                    </asp:DropDownList>
                    <asp:SqlDataSource runat="server" ID="SqlDataProduct" ConnectionString='<%$ ConnectionStrings:dbGNEnterpriseConStr %>'
                        SelectCommand="SELECT * FROM [tblProduct]"></asp:SqlDataSource>
                </ItemTemplate>
                <FooterTemplate>
                    <asp:DropDownList ID="ddlProductNameAdd" runat="server" DataSourceID="SqlDataProduct" DataTextField="productName" DataValueField="productId">
                    </asp:DropDownList>
                    <asp:SqlDataSource runat="server" ID="SqlDataProduct" ConnectionString='<%$ ConnectionStrings:dbGNEnterpriseConStr %>'
                        SelectCommand="SELECT * FROM [tblProduct]"></asp:SqlDataSource>
                </FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Quantity" SortExpression="tempSalesItemQuantity">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("tempSalesItemQuantity") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("tempSalesItemQuantity") %>'></asp:TextBox>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <asp:TemplateField Header  SortExpression="tempSalesItemTotal">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("tempSalesItemTotal") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("tempSalesItemTotal") %>'></asp:TextBox>
                </ItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtTotal" runat="server" Text='<%# Bind("tempSalesItemTotal") %>'></asp:TextBox>
                </FooterTemplate>
                <%--   <FooterTemplate>
                    <asp:TextBox ID="txtTotal" runat="server" Text='<%# Bind("tempSalesItemTotal") %>'></asp:TextBox>
                </FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Action" ShowHeader="False">
                ...
                <FooterTemplate>
                    <asp:ImageButton ImageUrl="~/Image/add.png" ID="addIB" runat="server" CommandName="Add New" ToolTip="Add New" Width="30px" Height="30px" OnClick="linkBtnInsert_Click" />
                </FooterTemplate>
            </asp:TemplateField>
        </Columns>
        <FooterStyle BackColor="#CCCCCC" />
    ...
    <%--    <asp:SqlDataSource ID="SqlDataTemp" runat="server" ConnectionString="<%$ ConnectionStrings:dbGNEnterpriseConStr %>"
        ...
        InsertCommand="INSERT INTO [tblTempSalesItem] ([tempSalesItemQuantity], [tempSalesItemTotal], [tempSalesItemProductName]) VALUES (@tempSalesItemQuantity, @tempSalesItemTotal, @tempSalesItemProductName)"
        SelectCommand="SELECT * FROM [tblTempSalesItem]" UpdateCommand="UPDATE [tblTempSalesItem] SET [tempSalesItemQuantity] = @tempSalesItemQuantity, [tempSalesItemTotal] = @tempSalesItemTotal, [tempSalesItemProductName] = @tempSalesItemProductName WHERE [tempSalesItemId] = @tempSalesItemId">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="tempSalesItemProductName" Type="Int32" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="tempSalesItemQuantity" Type="Decimal" />
            <asp:Parameter Name="tempSalesItemTotal" Type="Decimal" />
    ...
    <%--<table class="auto-style23">
        ...
        <tr>
            <td>
                <asp:Label ID="lblSR1" runat="server" Text="SRNO 1"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtSRNo1" runat="server" Width="177px"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
            <td>
            ...
            <td class="auto-style60">
                <asp:DropDownList ID="ddlGST" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlGST_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="5">5% GST</asp:ListItem>
                    <asp:ListItem Value="12">12% GST</asp:ListItem>
                    <asp:ListItem Value="18">18% GST</asp:ListItem>
        ...
        <tr>
            <td>
                <asp:Label ID="lblSR2" runat="server" Text="SRNO 2"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtSRNo2" runat="server" Width="177px"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
            <td>
            ...
            <td class="auto-style58">&nbsp;</td>
            <td class="auto-style60">
                <asp:Label ID="lblRoundOff" runat="server" Text="R/O"></asp:Label>
            </td>            
            <td class="auto-style45">
        ...
        <tr>
            <td>
                <asp:Label ID="lblSR3" runat="server" Text="SRNO 3"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtSRNo3" runat="server" Width="177px"></asp:TextBox>
            </td>
        ...
        <tr>
            <td colspan="4"><asp:Label ID="lblGrandTotalValueWithGSTAfterRoundOffInWords" runat="server" Text=""></asp:Label></td>
        </tr>
    </table>--%>
